...
public class Advertisements
{
    ...
    public Advertisements()
    {
        ...
        dictionary.put(30, "Hot foodstuffs in Chipotle");
        ...
        dictionary.put(50, "Did you know that in terms of human-pokemon compatibility, vaporeo-");
